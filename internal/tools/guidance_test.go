...
func TestStandardMetricsGuidanceContent(t *testing.T) {
	...
	for _, want := range []string{
		...
		"The family reports the\n  count of scored projects and their mean score",
		"before that day the layer's average still reads the v1 score",
		...
		"Until the lf-dbt DBT-1 deployment lands, call the average the v1 score; the count and the categories are v2.",
